...
// InsertionSort untuk mengurutkan berdasarkan rating
func InsertionSort(data [][]string) [][]string {
	n := len(data)
	for i := 1; i < n; i++ {
		key := data[i]
		j := i - 1
...
func main() {
	...
	fmt.Println("Mengurutkan dengan Insertion Sort...")
...
func main() {
	...
	fmt.Println("Mengurutkan dengan Bubble Sort...")
